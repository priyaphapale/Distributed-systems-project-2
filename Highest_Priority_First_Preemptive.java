...
public class Highest_Priority_First_Preemptive{
	...
	public static void main(String[] args) {
		...
		Highest_Priority_First_Preemptive hpfp = new Highest_Priority_First_Preemptive(processes);

		String table = "";
		for (Process_Handler process : hpfp.getProcesses()) {
	...
	public Highest_Priority_First_Preemptive(ArrayList<Process_Handler> processes) {
